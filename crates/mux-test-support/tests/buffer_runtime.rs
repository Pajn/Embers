...
use mux_core::{PtySize, new_request_id};
use mux_protocol::{
...
async fn send_input(connection: &mut TestConnection, buffer_id: mux_core::BufferId, input: &str) {
    let response = connection
...
async fn detach_buffer(connection: &mut TestConnection, buffer_id: mux_core::BufferId) {
    let response = connection
...
async fn kill_buffer(connection: &mut TestConnection, buffer_id: mux_core::BufferId) {
    let response = connection
