...
use mux_core::{BufferId, NodeId, SessionId};
use mux_protocol::{BufferRecord, ServerEvent, SessionRecord, SessionSnapshot, SnapshotResponse};

#[derive(Clone, Debug, Default, PartialEq, Eq)]
pub struct ClientState {
    pub sessions: BTreeMap<SessionId, SessionRecord>,
    pub buffers: BTreeMap<BufferId, BufferRecord>,
    pub nodes: BTreeMap<NodeId, mux_protocol::NodeRecord>,
    pub floating: BTreeMap<mux_core::FloatingId, mux_protocol::FloatingRecord>,
