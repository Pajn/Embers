use mux_core::{SessionId, SplitDirection};
use mux_server::{BufferAttachment, Node, ServerState, SplitNode, TabsNode};
...
fn tabs_node(state: &ServerState, node_id: mux_core::NodeId) -> TabsNode {
...
fn split_node(state: &ServerState, node_id: mux_core::NodeId) -> SplitNode {
