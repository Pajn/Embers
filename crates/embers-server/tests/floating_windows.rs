use embers_core::{FloatGeometry, SessionId};
use embers_server::{BufferAttachment, Node, ServerState, TabEntry};

fn root_leaf(state: &ServerState, session_id: SessionId) -> embers_core::NodeId {
    state
        .session(session_id)
