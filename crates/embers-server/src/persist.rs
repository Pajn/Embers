...
pub fn restored_session(session: PersistedSession) -> Session {
    Session {
...
pub fn restored_buffer(buffer: PersistedBuffer) -> Buffer {
    Buffer {
...
fn restored_buffer_state(state: PersistedBufferState) -> BufferState {
    match state {
...
fn timestamp_from_millis(millis: u64) -> Timestamp {
