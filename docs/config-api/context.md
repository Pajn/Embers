...
<div group="current_buffer" id="current_buffer-Example" class="tabcontent"  style="display: none;" >
...
<div style='box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2); padding: 15px; border-radius: 5px; border: 1px solid var(--theme-hover)'>
    <h2 class="func-name"> <code>fn</code> current_mode </h2>
...
<div group="current_mode" id="current_mode-Description" class="tabcontent"  style="display: block;" >
...
<div style='box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2); padding: 15px; border-radius: 5px; border: 1px solid var(--theme-hover)'>
    <h2 class="func-name"> <code>fn</code> event </h2>
...
<div group="event" id="event-Description" class="tabcontent"  style="display: block;" >
